...
export default class Analuus extends React.Component {
  render() {
    return <div className="mt-3">
      <p> Küsitluste tulemused on eelnevatel lehtedel muudetud interaktiivseteks.  Küsimusele klikkides ilmuvad tulemused tulpdiagrammide näol, millele liikudes näeb numbrilist väärtust.</p>
      ...
      <Row>
        <Col>
          ...
          <p>Peaagu alati ja alati olid valikuteks ühistransport ja jalgis, 67% vastanuist. Peaaegu alati või alati viiakse kooli autoga umbes veerdandit (32%) vastanuist. Koolist koju aga kasutatakse vaid kümnendikul juhtudel (9%) alati või peaaegu alati autot. Üldjuhul on auto asendunud ühistranspordiga. Mitte üldse või vähesel määral kasutatakse muud liikumiisviisi (ratas, tõukeratas, mõni muu motoriseerimata liiklusvahend) </p>
        ...
        <Col>
          ...
          <p>Ühistranspordi eelistajad põhjendasid oma eelistust mugava ühistranspordiühenduse olemasoluga, kiirusega ning auto puudumisega perkonnas. Veel toodi välja järgmisi põhjuseid "Isesesvus ja liikumine on vajalik", "Sõpradega ühistranspordis lõbusam", "Laps saab liikuda ja ärkab korralikult ülesse","Tahavad ise minna bussiga.", "kõige mõistlikum lahendus nii aja kokkuhoiu kui keskkonna säästu seisukohast""Meie liikumisteed on erinevad ja laps jõuab mugavalt kooli"</p>
...
Lastel iseseisvalt kooli minemiseks/tulemiseks kulub alla 10 minuti 28% vastajatel. 11-30 minutit võtab iseseisev teekond kooli 42% vastajatel, ning üle 30 minuti 30% vastajatel.</p>
      ...
      <Row>
        <Col>
          ...
          <ul>
            ...
            <li>„Ühel pool aeda ei ole ülekäigurada.“</li>
      ...
      <p>Aktiivsemateks vastajateks laste hulgas olid ülekaalukalt 7-9 klassi õpilased, ning lastevanematest vastas enim 1-3 klassi lastevaemaid. NIi nagu ka laste vastustes selgus, tuuakse autoga kooli umbes kolmandikku lastast, kuid koolist koju sõidavad autoga alla kümnendiku lastest. Siit võib järeldada, et problemaatiline ajavahemik kooli ümber toimuvast liiklusmöllust langeb just hommikusse aega. Populaarseim phjus, miks lapsi autoga kooli tuuakse oli koolitee kattumine lapsevanema töölesõidu marsruudiga</p>
